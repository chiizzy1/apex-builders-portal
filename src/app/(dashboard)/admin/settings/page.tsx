        ...
        <aside className="w-full lg:w-[30%] flex flex-col gap-6 sticky top-28">
          <nav className="bg-[#21242D] rounded-3xl p-4 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] border border-white/5 overflow-hidden">
            <ul className="flex flex-col space-y-1">
              ...
              <li>
                <button className="w-full flex items-center gap-4 px-4 py-4 text-slate-400 hover:text-white hover:bg-white/5 rounded-2xl transition-all group">
                  <span className="material-symbols-outlined group-hover:scale-110 transition-transform duration-300">group</span>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start mb-10 relative z-10">
              <div className="relative group/avatar cursor-pointer">
                <div className="w-32 h-32 rounded-full border-4 border-[#21242D] shadow-xl overflow-hidden relative">
                  <img
                    ...
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuCaIiMsKbp_YRA8Vbj9xm0gdKvEI5A8TD0d8HBs5YfW7bTNgjxsB5a0-ny1gOr57mo8Yalg1Kut4vXYqDG5qlYXl8-BzUCN57whAAxvMpLYiG-1hb09187s0kFO-XM0oFiFXKfFYuAPo9oiEMg1NyUPLQSZRvRl2F1LFGCrO4m5sPXsQKYkvucHGXYMaGob4jL08jRWdJ0Gbni66X7Vw9JFxFDmVBp4a0F9H1McGobrjjUdTTS73VUza6qewZH4AIbi280ySP2kbDY"
                  />
              ...
              <div className="text-center md:text-left pt-2">
                ...
                <p className="text-slate-400 text-sm mt-2 max-w-md leading-relaxed">
                  Upload a high-resolution image to help your team recognize you. Allowed formats: JPG, PNG, or GIF. Max size 2MB.
                </p>
              </div>
            </div>
              ...
              <label className="flex flex-col gap-2 group/input">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="email"
                    defaultValue="james.anderson@apexbuilders.com"
                  />
                </div>
              </label>
              ...
              <label className="flex flex-col gap-2 md:col-span-2 group/input">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={3}
                    defaultValue="Lead Architect with over 10 years of experience in sustainable luxury construction."
                  />
                </div>
              </label>
            </form>
