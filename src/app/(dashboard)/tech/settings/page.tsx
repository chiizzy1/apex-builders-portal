    ...
    <div className="flex-1 w-full max-w-[1280px] mx-auto px-4 lg:px-10 py-8 lg:py-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
          ...
          <p className="text-slate-400 mt-2">Manage your technician profile details and security.</p>
        </div>
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start mb-10 relative z-10">
              <div className="relative group/avatar cursor-pointer">
                <div className="w-32 h-32 rounded-full border-4 border-[#21242D] shadow-xl overflow-hidden relative">
                  <img
                    ...
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuB7rWcS-y99X0aTydnhhHaYDhzJIocpeBOnrQEoJQqL-BTUw3XqkHW2QxAaqqPTW_EVKCabVwCccxCsSzQsvB1U8D_-BSZudWWqVD__m2r0p8aEIjaWsrIfWIMKuMgAx9k3GBbvN0lNWht_uKWcBzg48qjhsxW8XrsHUtHXbSffsh8_t2iPiPcXp8Wbt8rVJB7RBKLexAL8mbyHsqi4fd5SH4cggpDEpsDAEGpnNJsVQpP_VKBO_arJ1e7JKSyQ_NtxsQ7o2EYtPUo"
                  />
              ...
              <div className="text-center md:text-left pt-2">
                ...
                <p className="text-slate-400 text-sm mt-2 max-w-md leading-relaxed">
                  Upload a high-resolution portrait. This helps clients recognize you when you arrive at the job site.
                </p>
              </div>
            </div>
              ...
              <label className="flex flex-col gap-2 group/input">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="email"
                    defaultValue="marcus.d@apexbuilders.com"
                  />
                </div>
              </label>
              ...
              <label className="flex flex-col gap-2 md:col-span-2 group/input">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={2}
                    defaultValue="Master Electrician, HVAC Certified, Scaffolding Safety Officer"
                  />
                </div>
              </label>
            </form>
