      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-[#13151A] rounded-3xl border border-white/10 shadow-2xl overflow-hidden max-h-[90vh] flex flex-col"
          >
            {/* Glow accent */}
                ...
                <>
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-slate-400 text-sm">
                      They&apos;ll receive a temporary password and can reset it via email.
                    </p>
                  </div>
                  ...
                  <AnimatePresence>
                    {submitState === "error" && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: -10 }}
                        className="mb-4 flex items-center gap-3 px-4 py-3 rounded-xl bg-red-500/10 border border-red-500/20 text-red-400 text-sm"
                      >
