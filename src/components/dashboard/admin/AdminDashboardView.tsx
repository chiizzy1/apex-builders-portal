...
export function AdminDashboardView({ stats, projects }: AdminDashboardViewProps) {
  ...
  return (
    <div className="max-w-[1600px] mx-auto flex flex-col gap-6 min-w-0">
      {/* Header Bar (Floating) */}
      <header className="w-full shadow-floating rounded-3xl px-[clamp(1.25rem,4vw,2rem)] py-[clamp(1rem,2vw,1.25rem)] flex items-center justify-between border border-white/5 sticky top-0 z-10 before:absolute before:inset-0 before:bg-card/70 before:backdrop-blur-xl before:rounded-3xl before:-z-10 min-w-0">
        <div className="flex flex-col relative z-20 min-w-0 pr-4">
          <h1 className="text-[clamp(1.5rem,3vw,2.5rem)] font-bold text-white text-balance tracking-tight truncate">
            Hello, <span className="text-primary">James!</span>
          </h1>
          <p className="text-muted-foreground text-sm font-medium mt-0.5 truncate">Welcome back to Apex Builders Command.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {/* KPI 1: Revenue */}
        <div className="bg-card shadow-floating rounded-3xl p-[clamp(1.25rem,3vw,1.5rem)] border border-white/5 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="flex flex-col h-full justify-between relative z-10">
            ...
            <div>
              <h2 className="text-[clamp(2rem,4vw,2.5rem)] font-bold text-white tracking-tight mt-2 mb-1">
        ...
        <div className="bg-card shadow-floating rounded-3xl p-[clamp(1.25rem,3vw,1.5rem)] border border-white/5 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="flex flex-col h-full justify-between relative z-10">
            ...
            <div>
              <h2 className="text-[clamp(2rem,4vw,2.5rem)] font-bold text-white tracking-tight mt-2 mb-1">
                842<span className="text-[clamp(1.25rem,2vw,1.5rem)] text-muted-foreground font-medium ml-1">h</span>
              </h2>
        ...
        <div className="bg-card shadow-floating rounded-3xl p-[clamp(1.25rem,3vw,1.5rem)] border border-white/5 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-300">
          ...
          <div className="flex flex-col h-full justify-between relative z-10">
            ...
            <div>
              <h2 className="text-[clamp(2rem,4vw,2.5rem)] font-bold text-white tracking-tight mt-2 mb-1">98%</h2>
              <div className="flex items-center gap-1 text-success text-sm font-semibold bg-success/10 px-2 py-1 rounded-lg w-fit">
      ...
      {/* Charts Section */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-auto lg:min-h-[420px] min-w-0">
        {/* Revenue Chart (Wide) */}
        <div className="lg:col-span-2 bg-card shadow-floating rounded-3xl p-[clamp(1.25rem,4vw,2rem)] border border-white/5 flex flex-col justify-between relative overflow-hidden min-w-0">
          ...
          <div className="relative w-full h-full min-h-[250px] flex items-end px-2 pb-4 min-w-0">
            {/* Grid Lines */}
            ...
            {/* Tooltip Fake */}
            <div className="absolute top-[20%] right-[15%] bg-[#1A1D24] border border-primary/30 p-3 rounded-xl shadow-xl flex flex-col gap-1 z-20">
              <span className="text-xs text-muted-foreground">Net Income</span>
              <span className="text-white font-bold">$842,000</span>
            </div>
          </div>
          {/* X-Axis Labels */}
          <div className="flex justify-between text-xs text-muted-foreground mt-2 px-1 min-w-0 overflow-x-auto custom-scrollbar gap-4">
            <span className="shrink-0">Jan</span>
            <span className="shrink-0">Feb</span>
            <span className="shrink-0">Mar</span>
            <span className="shrink-0">Apr</span>
            <span className="shrink-0">May</span>
            <span className="shrink-0">Jun</span>
            <span className="shrink-0">Jul</span>
            <span className="shrink-0">Aug</span>
            <span className="shrink-0">Sep</span>
            <span className="shrink-0">Oct</span>
            <span className="shrink-0">Nov</span>
            <span className="shrink-0">Dec</span>
          </div>
        </div>

        {/* Resource Allocation (Donut) */}
        <div className="bg-card shadow-floating rounded-3xl p-[clamp(1.25rem,4vw,2rem)] border border-white/5 flex flex-col items-center justify-between overflow-hidden">
          ...
          <div className="relative flex-1 w-full max-w-[240px] aspect-square min-h-[160px] flex items-center justify-center my-4 min-w-0 mx-auto">
            <svg className="w-full h-full -rotate-90 overflow-visible" viewBox="0 0 40 40">
              {/* Background Circle */}
              <path
                className="text-[#1A1D24]"
                d="M20 4 a 16 16 0 0 1 0 32 a 16 16 0 0 1 0 -32"
                fill="none"
                stroke="currentColor"
                strokeWidth="4"
              ></path>
      ...
      <div className="bg-card shadow-floating rounded-3xl p-[clamp(1.25rem,4vw,2rem)] border border-white/5 mb-8 min-w-0 overflow-hidden">
        ...
        <div className="w-full min-w-0">
          <table className="w-full border-collapse block md:table">
            ...
            <tbody className="text-white block md:table-row-group">
              {displayProjects.length > 0 ? (
                displayProjects.map((project) => {
                  ...
                  return (
                    <tr
                      key={project.id}
                      className="group p-4 md:p-0 flex flex-col md:table-row gap-4 md:gap-0 bg-white/2 md:bg-transparent rounded-2xl md:rounded-none md:hover:bg-white/2 transition-colors border border-white/5 md:border-0 md:border-b last:border-0 mb-4 md:mb-0 relative"
                    >
                      <td className="md:py-5 md:pl-4 block md:table-cell">
                        <div className="flex items-center gap-4">
                          ...
                          <button className="md:hidden ml-auto p-2 rounded-lg bg-white/5 hover:bg-white/10 text-muted-foreground transition-colors shrink-0">
                            <ChevronRight className="size-5" />
                          </button>
                        </div>
                      </td>
                      <td className="md:py-5 block md:table-cell">
                        <div className="flex justify-between items-center md:block">
                          <span className="md:hidden text-xs text-muted-foreground uppercase tracking-wider font-semibold">
                            Status
                          </span>
                          <span
                      ...
                      <td className="md:py-5 md:pr-8 block md:table-cell">
                        <div className="flex flex-col gap-2 w-full">
                          <div className="flex justify-between text-xs font-medium">
                            <span className="text-muted-foreground capitalize">{project.category}</span>
                            <span className="text-primary">{progressPct}%</span>
                          </div>
                          <div className="w-full h-2 bg-[#1A1D24] md:bg-[#1e2128] rounded-full overflow-hidden">
                            <div
                      ...
                      <td className="hidden md:table-cell md:py-5 md:pr-4 text-right">
